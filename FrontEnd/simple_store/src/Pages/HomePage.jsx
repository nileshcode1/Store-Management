        ...
        <Box width={"100%"}>
          ...
          <Box w={"85%"} p={10} display={"flex"} m={"auto"} gap={2}>
            ...
            >
              ...
              <option
                value={
                  "https://d212y4fjk9i0rg.cloudfront.net/sites/default/files/sunlitee554x652.png"
                }
              >
                Sunflower Oil
              </option>
            ...
            <Button width={20} onClick={handleAdd} colorScheme="whatsapp">
              ADD
            </Button>
          </Box>
          <Box w={"100%"} display={"flex"} justifyContent={"space-around"}>
            ...
            <Box w={200}>
              <Text pl={9} pt={6} pb={3} fontWeight={"bold"} fontSize={"large"}>
                {" "}
                STOCK STATUS
              </Text>
               {/* RADIO COMPONENT */}
